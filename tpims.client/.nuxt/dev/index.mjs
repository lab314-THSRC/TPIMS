...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-scripts": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/public"
      ]
    },
    "http": {
      "domains": []
...
const _buYCiCKqleCnayg7qjty3RgXQUEwHwMEGVqjUr7o = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"TPIMS"};
...
const _QvZWOFkOXCi4Ins8GozAkRNb2lNLi4AsBZWSu4_Wz0 = (nitroApp) => {
...
const _8LH32smWu3mEfkIM5po19gmgAgMFfDlXeeSp2pCNpUE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _buYCiCKqleCnayg7qjty3RgXQUEwHwMEGVqjUr7o,
_QvZWOFkOXCi4Ins8GozAkRNb2lNLi4AsBZWSu4_Wz0,
_8LH32smWu3mEfkIM5po19gmgAgMFfDlXeeSp2pCNpUE
];
...
const _liL4yo = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _gcmh7l = eventHandler(async (event) => {
  ...
  return await import('file:///Users/elviswu/Documents/c_sharp_proj/TPIMS/tpims.client/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _4PZuPj = eventHandler(async (event) => {
...
const _1uTyfj = lazyEventHandler(() => {
...
const _lazy_oqCFsi = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _liL4yo, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_oqCFsi, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _gcmh7l, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _4PZuPj, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _1uTyfj, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_oqCFsi, lazy: true, middleware: false, method: undefined },
  { route: '/_scripts/**', handler: _lazy_oqCFsi, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_oqCFsi, lazy: true, middleware: false, method: undefined }
];
